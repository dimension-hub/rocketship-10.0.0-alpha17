...
<li>collections.language.es (will ignore spanish translations)</li>
<li>collections.language.* (will ignore all translations)</li>
<li>collections.~language.nl (will force import the dutch translations even if ignoring others with a wildcard)</li>
</ul>');
