 ...
 */
trait LayoutBuilderRestrictionsByRoleHelperTrait {
   ...
   */
  protected function roleRestrictionStatus(string $role, $static_id = NULL, $entity_view_display_id = NULL) {
   ...
   */
  protected function roleRestrictionsStatusString(string $role, $static_id = NULL, $entity_view_display_id = NULL) {
    $restriction = $this->roleRestrictionStatus($role, $static_id, $entity_view_display_id);
    if ($restriction == TRUE) {
      return 'Restricted';
    }
   ...
   * @return string
   */
  protected function layoutRoleRestrictionStatusString(string $role, string $layout_plugin_id, $static_id = NULL, $entity_view_display_id = NULL) {
    $restriction = $this->layoutRoleRestrictionStatus($role, $layout_plugin_id, $static_id, $entity_view_display_id);
    $addendum = '';
   ...
   * @return bool
   */
  protected function layoutRoleRestrictionStatus(string $role, string $layout_plugin_id, $static_id = NULL, $entity_view_display_id = NULL) {
    $settings = $this->getSettings($entity_view_display_id, $static_id);
   ...
   * @throws \Drupal\Component\Plugin\Exception\PluginNotFoundException
   */
  protected function getSettings($entity_view_display_id = NULL, $static_id = NULL) {
